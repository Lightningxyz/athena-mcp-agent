...
**Athena** is a high-performance, local-first coding agent CLI designed for **grounded code understanding**, **autonomous patch execution**, and **safe validation loops**.
